...
import { NgbNav, NgbNavItem, NgbNavLinkButton, NgbNavLinkBase, NgbNavContent, NgbNavOutlet } from '@ng-bootstrap/ng-bootstrap/nav';
...
export class Switcher {
  ...
  updatemenuType(navigationStyles: string) {
    ...
    if (navigationStyles == 'horizontal') {
      this.appStateService.updateState({ navigationStyles, layoutStyles: '', menuStyles: 'menu-click' });
