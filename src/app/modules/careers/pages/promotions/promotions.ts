...
export class PromotionsPage implements OnInit {
  private readonly moveType: CareerMove['type'] = 'Promotion';
  ...
  form = this.fb.group({
    ...
    status: ['Propose', [Validators.required]],
  });
  ...
  saveMove(): void {
    ...
    const payload: CreateCareerMovePayload = {
      ...
      status: this.form.value.status || 'Propose',
    };
    ...
    this.careersService
      ...
      .subscribe({
        next: () => {
          this.toastr.success('Promotion enregistree avec succes', 'Carriere', {
            timeOut: 2500,
